<template>
<footer>
    <div class="bg-orange-500 py-2 text-white">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          ...
          <div class="px-4 lg:mt-8 lg:mb-4 w-full sm:w-auto">
            <div>
              <!----<h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Blog</h2>-->
            </div>
            <div class="flex font-nunito font-normal">
              <a href="/" class="mr-4">Blog</a>
              <a href="/blog" class="mr-4">About</a>
    ...
    <div class="bg-neutral-700 py-2 text-gray-100">
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center sm:w-auto sm:text-left font-nunito font-normal">
            2024 © Memeworld Limited
          </div>
